...
#     url0 = hefeng_air + 'key=' + key + '&location=' + city
#     url1 = hefeng_lifestyle + 'key=' + key + '&location=' + city
#     url2 = hefeng_solarsunrise_sunset + 'key=' + key + '&location=' + city
#     url3 = hefeng_weather + 'key=' + key + '&location=' + city
#     url4 = hefeng_forecast + 'key=' + key + '&location=' + city
#     url5 = hefeng_hourly + 'key=' + key + '&location=' + city
#     url6 = hefeng_now + 'key=' + key + '&location=' + city
#     #
#     print(url0)
#     print(url1)
#     print(url2)
...
#         'lifestyle': {
#             'comf': r1['HeWeather6'][0]['lifestyle'][0]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][0]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][0]['txt'],
#             'drsg': r1['HeWeather6'][0]['lifestyle'][1]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][1]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][1]['txt'],
#             'flu': r1['HeWeather6'][0]['lifestyle'][2]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][2]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][2]['txt'],
#             'sport': r1['HeWeather6'][0]['lifestyle'][3]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][3]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][3]['txt'],
#             'trav': r1['HeWeather6'][0]['lifestyle'][4]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][4]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][4]['txt'],
#             'uv': r1['HeWeather6'][0]['lifestyle'][5]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][5]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][5]['txt'],
#             'cw': r1['HeWeather6'][0]['lifestyle'][6]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][6]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][6]['txt'],
#             'air': r1['HeWeather6'][0]['lifestyle'][7]['type'] + '...' + r1['HeWeather6'][0]['lifestyle'][7]['brf'] + '...' + r1['HeWeather6'][0]['lifestyle'][7]['txt'],
#                      },
#         'sunrise_sunset': {
#             'mr0': r2['HeWeather6'][0]['sunrise_sunset'][0]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][0]['mr'],
#             'mr1': r2['HeWeather6'][0]['sunrise_sunset'][1]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][1]['mr'],
#             'mr2': r2['HeWeather6'][0]['sunrise_sunset'][2]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][2]['mr'],
#             'ms0': r2['HeWeather6'][0]['sunrise_sunset'][0]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][0]['ms'],
#             'ms1': r2['HeWeather6'][0]['sunrise_sunset'][1]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][1]['ms'],
#             'ms2': r2['HeWeather6'][0]['sunrise_sunset'][2]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][2]['ms'],
#             'sr0': r2['HeWeather6'][0]['sunrise_sunset'][0]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][0]['sr'],
#             'sr1': r2['HeWeather6'][0]['sunrise_sunset'][1]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][1]['sr'],
#             'sr2': r2['HeWeather6'][0]['sunrise_sunset'][2]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][2]['sr'],
#             'ss0': r2['HeWeather6'][0]['sunrise_sunset'][0]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][0]['ss'],
#             'ss1': r2['HeWeather6'][0]['sunrise_sunset'][1]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][1]['ss'],
#             'ss2': r2['HeWeather6'][0]['sunrise_sunset'][2]['date'] + ':' + r2['HeWeather6'][0]['sunrise_sunset'][2]['ss'],
#
#         },
#
